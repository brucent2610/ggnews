...
<?php
    ...
    ggnews_menu_sub("product_cat", $danhmucthuonghieu->term_id, "Thương hiệu");
?>
<hr>
<?php
    $args=array(
...
<!--    <a href="#" class="hidden-sm"><img src="--><?php //echo get_template_directory_uri() ?><!--/media/img/banner/8-real.jpg" alt="slider-banner"></a>-->
<!--</div>-->